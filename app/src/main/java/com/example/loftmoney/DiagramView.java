...
public class DiagramView extends View {
    ...
    public void init (Context context, AttributeSet attrs){
        if(attrs != null){
            expensePaint.setColor(ContextCompat.getColor(context, R.color.dark_grey_blue));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(xMargin, yMargin + space, getWidth()-xMargin+space, getHeight()-yMargin,
